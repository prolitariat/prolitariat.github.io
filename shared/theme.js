...
(function () {
  ...
  css.textContent = `
    ...
    /* Text colors — Tailwind gray overrides */
    ...
    [data-theme="dark"] .prose h2 { color: #f3f4f6 !important; }
    [data-theme="dark"] .prose h3 { color: #e5e7eb !important; }
    [data-theme="dark"] .prose p { color: #d1d5db !important; }
    [data-theme="dark"] .prose li { color: #d1d5db !important; }
    [data-theme="dark"] .prose strong { color: #f3f4f6 !important; }
    [data-theme="dark"] .prose blockquote { color: #9ca3af !important; border-left-color: rgba(99, 102, 241, 0.5) !important; }
    [data-theme="dark"] .prose a { color: #818cf8 !important; text-decoration-color: rgba(129, 140, 248, 0.3) !important; }
    [data-theme="dark"] .prose a:hover { text-decoration-color: rgba(129, 140, 248, 0.8) !important; }
    ...
    [data-theme="dark"] .stat-number { color: #818cf8 !important; }
    ...
    [data-theme="dark"] .stats-card dt { color: #9ca3af !important; }
    [data-theme="dark"] .stats-card dd { color: #f3f4f6 !important; }

    /* Links */
    [data-theme="dark"] a.text-indigo-500,
    [data-theme="dark"] a.text-indigo-600 { color: #818cf8 !important; }
    [data-theme="dark"] a.text-indigo-500:hover,
    [data-theme="dark"] a.text-indigo-600:hover { color: #a5b4fc !important; }

    /* Music page specifics */
    [data-theme="dark"] .timeline-line {
      background: linear-gradient(to bottom, rgba(129, 140, 248, 0.3), rgba(129, 140, 248, 0.05)) !important;
    }
    [data-theme="dark"] .timeline-dot {
      border-color: rgba(30, 30, 50, 0.8) !important;
    ...
    [data-theme="dark"] .bg-white { background: rgba(30, 30, 50, 0.6) !important; }
    [data-theme="dark"] .bg-gray-50 { background: rgba(30, 30, 50, 0.4) !important; }
    [data-theme="dark"] .bg-indigo-600 { background: #4f46e5 !important; }
    [data-theme="dark"] .bg-indigo-600:hover { background: #4338ca !important; }

    /* Hover states */
    [data-theme="dark"] .hover\\:text-gray-900:hover { color: #f3f4f6 !important; }
    [data-theme="dark"] .hover\\:text-indigo-600:hover { color: #818cf8 !important; }
